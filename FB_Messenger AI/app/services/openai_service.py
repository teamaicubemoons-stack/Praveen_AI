...
class OpenAIService:
    ...
    async def get_intent_and_response(self, user_message: str, chat_history: list = []):
        """
        Classifies intent and generates a response tailored for Cubemoons FB Messenger.
        Automatically detects language and maintains a professional, human-like tone.
        """
        system_prompt = """
        You are a human Sales Representative/Staff member for Praveen Trading Company, a wholesale clothing business based in India. You handle customer inquiries on Facebook Messenger.

        ### ABOUT THE BUSINESS:
        - Business Name: Praveen Trading Company
        - Facebook Page: Praveen Trading Company
